...
describe('Collapse', () => {
  ...
  it('接受 selected 属性', (done) => {
    ...
    div.innerHTML = `
        <mo-collapse :selected="xxx">
          <mo-collapse-item title="标题1" name="1"><span id="content-1">1</span></g-collapse-item>
          <mo-collapse-item title="标题2" name="2"><span id="content-2">2</span></g-collapse-item>
          <mo-collapse-item title="标题3" name="3"><span id="content-3">3</span></g-collapse-item>
        </mo-collapse>
    `
    const vm = new Vue({
      el: div,
  ...
  it('接受 single 属性', (done) => {
    ...
    document.body.appendChild(div)
    div.innerHTML = `
        <mo-collapse :selected.sync="xxx" single>
          <mo-collapse-item title="标题1" name="1"><span id="content-1">1</span></g-collapse-item>
          <mo-collapse-item title="标题2" name="2"><span id="content-2">2</span></g-collapse-item>
          <mo-collapse-item title="标题3" name="3"><span id="content-3">3</span></g-collapse-item>
        </mo-collapse>
  ...
  it('触发 update:selected 事件', (done) => {
    ...
    document.body.appendChild(div)
    div.innerHTML = `
        <mo-collapse :selected="xxx" @update:selected="onSelect">
          <mo-collapse-item title="标题1" name="1"><span id="content-1">1</span></g-collapse-item>
          <mo-collapse-item title="标题2" name="2"><span id="content-2">2</span></g-collapse-item>
          <mo-collapse-item title="标题3" name="3"><span id="content-3">3</span></g-collapse-item>
        </mo-collapse>
